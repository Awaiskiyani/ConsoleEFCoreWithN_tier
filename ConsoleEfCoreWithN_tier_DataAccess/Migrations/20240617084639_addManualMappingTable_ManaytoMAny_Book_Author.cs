...
{
    /// <inheritdoc />
    public partial class addManualMappingTable_ManaytoMAny_Book_Author : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAuthorMap", x => new { x.AuthorId, x.BoodId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BookAuthorMap_Books_BoodId",
                        column: x => x.BoodId,
