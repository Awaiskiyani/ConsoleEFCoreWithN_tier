...
namespace ConsoleEfCoreWithN_tier_DataAccess.Migrations
{
    ...
    [Migration("20240617163312_addfluentManytoManyRelation_MappingTable")]
    partial class addfluentManytoManyRelation_MappingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.BookAuthorMap", b =>
                {
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.FluentAuthor", b =>
                {
                    b.Property<int>("Author_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.FluentBook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.FluentBookAuthorMap", b =>
                {
                    b.Property<int>("AuthorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.FluentBookDetails", b =>
                {
                    b.Property<int>("BookDetail_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.FluentPublisher", b =>
                {
                    b.Property<int>("Publisher_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.BookAuthorMap", b =>
                {
                    b.HasOne("EFCoreWithN_tier_Model.Models.Author", "Author")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.FluentBook", b =>
                {
                    b.HasOne("EFCoreWithN_tier_Model.Models.FluentPublisher", "Publisher")
                        .WithMany("Books")
                        .HasForeignKey("Publisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.FluentBookAuthorMap", b =>
                {
                    b.HasOne("EFCoreWithN_tier_Model.Models.FluentAuthor", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreWithN_tier_Model.Models.FluentBook", "Book")
                        .WithMany("BookAuthorMap")
                        .HasForeignKey("BoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EFCoreWithN_tier_Model.Models.FluentBookDetails", b =>
                {
                    b.HasOne("EFCoreWithN_tier_Model.Models.FluentBook", "Book")
                        .WithOne("BookDetails")
                        .HasForeignKey("EFCoreWithN_tier_Model.Models.FluentBookDetails", "Book_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
